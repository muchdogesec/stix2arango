...
def main():
    ...
    commands = [
        {
            "file": os.path.join("cti_knowledge_base_store", "tlp", f"tlpv{version}-bundle.json"),
            "database": database,
            "collection": "tlp",
    ...
    files_to_download = [
        {
            "url": f"{base_url}tlp/tlpv{version}-bundle.json",
            "destination": os.path.join(root_path, "cti_knowledge_base_store", "tlp", f"tlpv{version}-bundle.json")
        } for version in versions
    ]
