...
def main():
    ...
    commands = [
        {
            "file": os.path.join("cti_knowledge_base_store", "mitre-attack-enterprise", f"enterprise-attack-{version}.json"),
            "database": database,
    ...
    # Download files
    base_url = "https://pub-ec5d029722ad46e6b29f3816e23329d8.r2.dev/"
    files_to_download = [
        {
            "url": f"{base_url}enterprise-attack-{version}.json",
