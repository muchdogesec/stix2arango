...
def main():
    ...
    commands = [
        {
            "file": os.path.join("cti_knowledge_base_store", "mitre-attack-ics", f"ics-attack-{version}.json"),
            "database": database,
    ...
    files_to_download = [
        {
            "url": f"{base_url}mitre-attack-ics-repo-data/ics-attack-{version}.json",
